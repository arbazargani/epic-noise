        ...
        <div class="ms_main_wrapper">
            ...
            <div class="ms_sidemenu_wrapper">
                ...
                <div class="ms_sidemenu_inner">
                    <div class="ms_logo_inner">
                        <div class="ms_logo">
                            <a href="index.html"><img src="{{ asset('assets/themes/mira/images/logo.png') }}" alt="" class="img-fluid"/></a>
                        </div>
                        <div class="ms_logo_open">
                            <a href="index.html"><img src="{{ asset('assets/themes/mira/images/open_logo.png') }}" alt="" class="img-fluid"/></a>
                        </div>
                    </div>
            ...
            <div class="ms_content_wrapper padder_top80">
                ...
                <div class="ms_header">
                    <div class="ms_top_left">
                        <div class="ms_top_search">
                            ...
                            <span class="search_icon">
                                <img src="{{ asset('assets/themes/mira/images/svg/search.svg') }}" alt="">
                            </span>
                        </div>
                    ...
                    <div class="ms_top_right">
                        <div class="ms_top_lang">
                            <span data-toggle="modal" data-target="#lang_modal">languages <img src="{{ asset('assets/themes/mira/images/svg/lang.svg') }}" alt=""></span>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="ms_banner_img">
                                    {{-- <img src="{{ asset('assets/themes/mira/images/banner.png') }}" alt="" class="img-fluid"> --}}
                                    <img src="{{ $featured_media->cover }}" alt="" class="img-fluid" style="padding: 5%">
                                </div>
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music1.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                                            </div>
                                            ...
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music2.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music3.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music4.jpg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music5.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/music/r_music6.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="col-lg-4 col-md-12 padding_right40">
                                    ...
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song1.jpg') }}" alt="" class="img-fluid">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song2.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song3.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song4.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song5.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="col-lg-4 col-md-12 padding_right40">
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song6.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song7.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box ms_active_play">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song8.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    {{-- <div class="ms_bars">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song9.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song11.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song12.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song13.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="ms_weekly_box">
                                    <div class="weekly_left">
                                        ...
                                        <div class="w_top_song">
                                            <div class="w_tp_song_img">
                                                <img src="{{ asset('assets/themes/mira/images/weekly/song14.jpg') }}" alt="" class="img-fluid">
                                                <div class="ms_song_overlay">
                                                </div>
                                                <div class="ms_play_icon">
                                                    <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                    ...
                    <div class="ms_feature_slider swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song1.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song2.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song3.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song4.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song5.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/featured/song6.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                ...
                <div class="ms_advr_wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="#"><img src="{{ asset('assets/themes/mira/images/adv.jpg') }}" alt="" class="img-fluid"/></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="ms_release_box">
                                    <div class="w_top_song">
                                        ...
                                        <div class="w_tp_song_img">
                                            <img src="{{ asset('assets/themes/mira/images/weekly/song1.jpg') }}" alt="">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_release_box">
                                    <div class="w_top_song">
                                        <span class="slider_dot"></span>
                                        <div class="w_tp_song_img">
                                            <img src="{{ asset('assets/themes/mira/images/weekly/song2.jpg') }}" alt="">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_release_box">
                                    <div class="w_top_song">
                                        <span class="slider_dot"></span>
                                        <div class="w_tp_song_img">
                                            <img src="{{ asset('assets/themes/mira/images/weekly/song3.jpg') }}" alt="">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_release_box">
                                    <div class="w_top_song">
                                        <span class="slider_dot"></span>
                                        <div class="w_tp_song_img">
                                            <img src="{{ asset('assets/themes/mira/images/weekly/song4.jpg') }}" alt="">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_release_box">
                                    <div class="w_top_song">
                                        <span class="slider_dot"></span>
                                        <div class="w_tp_song_img">
                                            <img src="{{ asset('assets/themes/mira/images/weekly/song5.jpg') }}" alt="">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                    ...
                    <div class="ms_album_slider swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album1.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album2.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album3.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album4.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album5.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img asset('assets/themes/mira/images/album/album6.jpg') alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="ms_genres_box">
                                <img src="{{ asset('assets/themes/mira/images/genrs/img1.jpg') }}" alt="" class="img-fluid" />
                                <div class="ms_main_overlay">
                                    <div class="ms_box_overlay"></div>
                                    <div class="ms_play_icon">
                                        <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="ms_genres_box">
                                        <img src="{{ asset('assets/themes/mira/images/genrs/img2.jpg') }}" alt="" class="img-fluid" />
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="col-lg-8">
                                    <div class="ms_genres_box">
                                        <img src="{{ asset('assets/themes/mira/images/genrs/img3.jpg') }}" alt="" class="img-fluid" />
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="col-lg-8">
                                    <div class="ms_genres_box">
                                        <img src="{{ asset('assets/themes/mira/images/genrs/img5.jpg') }}" alt="" class="img-fluid" />
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                                ...
                                <div class="col-lg-4">
                                    <div class="ms_genres_box">
                                        <img src="{{ asset('assets/themes/mira/images/genrs/img6.jpg') }}" alt="" class="img-fluid" />
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_play_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                        ...
                        <div class="col-lg-2">
                            <div class="ms_genres_box">
                                <img src="{{ asset('assets/themes/mira/images/genrs/img4.jpg') }}" alt="" class="img-fluid" />
                                <div class="ms_main_overlay">
                                    <div class="ms_box_overlay"></div>
                                    <div class="ms_play_icon">
                                        <img src="{{ asset('assets/themes/mira/images/svg/play.svg') }}" alt="">
                ...
                <div class="ms_advr_wrapper ms_advr2">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="#"><img src="{{ asset('assets/themes/mira/images/adv1.jpg') }}" alt="" class="img-fluid"/></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ms_radio_slider swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img1.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img2.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img3.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img4.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img5.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="ms_rcnt_box">
                                    <div class="ms_rcnt_box_img">
                                        <img src="{{ asset('assets/themes/mira/images/radio/img6.jpg') }}" alt="">
                                        <div class="ms_main_overlay">
                                            <div class="ms_box_overlay"></div>
                                            <div class="ms_more_icon">
                                                <img src="{{ asset('assets/themes/mira/images/svg/more.svg') }}" alt="">
            ...
            <div class="ms_footer_wrapper">
                <div class="ms_footer_logo">
                    <a href="index.html"><img src="{{ asset('assets/themes/mira/images/open_logo.png') }}" alt=""></a>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer_box footer_app">
                                ...
                                <a href="#" class="foo_app_btn"><img src="{{ asset('assets/themes/mira/images/google_play.jpg') }}" alt="" class="img-fluid"></a>
                                <a href="#" class="foo_app_btn"><img src="{{ asset('assets/themes/mira/images/app_store.jpg') }}" alt="" class="img-fluid"></a>
                                <a href="#" class="foo_app_btn"><img src="{{ asset('assets/themes/mira/images/windows.jpg') }}" alt="" class="img-fluid"></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                                ...
                                <ul class="foo_con_info">
                                    <li>
                                        <div class="foo_con_icon">
                                            <img src="{{ asset('assets/themes/mira/images/svg/phone.svg') }}" alt="">
                                        </div>
                                    ...
                                    <li>
                                        <div class="foo_con_icon">
                                            <img src="{{ asset('assets/themes/mira/images/svg/message.svg') }}" alt="">
                                        </div>
                                        <div class="foo_con_data">
                                    ...
                                    <li>
                                        <div class="foo_con_icon">
                                            <img src="{{ asset('assets/themes/mira/images/svg/add.svg') }}" alt="">
                                        </div>
                                        <div class="foo_con_data">
                                            ...
                                            <div class="knob-wrapper-outer">
                                                <div class="knob-wrapper">
                                                    <div class="knob-mask">
                                                        ...
                                                        <div class="round">
                                                            <img src="{{ asset('assets/themes/mira/images/svg/volume.svg') }}" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- <input></input> -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="ms_register_img">
                                <img src="{{ asset('assets/themes/mira/images/register_img.png') }}" alt="" class="img-fluid" />
                            </div>
